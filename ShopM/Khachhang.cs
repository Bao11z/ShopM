...
namespace ShopM
{
    public partial class Khachhang : Form
    {
        ...
        SqlConnection sql = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\QuanLyShopdb.mdf;Integrated Security=True;Connect Timeout=30");
